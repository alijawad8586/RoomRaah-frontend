 ...
 *
 * Imported by path rather than through `shared/components/index.ts`: the barrel is in the app
 * shell's bundle, and pulling it in here would drag every shared component into this
 * component's lazy chunk for the sake of three of them.
 */
@Component({
